...
/**
 * Type representing the data structure for workout image selection modal.
 *
 * @property {string} title - The title of the modal.
 * @property {string} message - The message to display to the user.
 * @property {() => void} onImageSelect - Callback function when images are selected.
 */
export type WorkoutImageSelectionData = {
  title: string;
  message: string;
