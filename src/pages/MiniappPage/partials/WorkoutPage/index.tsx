      ...
      <div className={styles.historySection}>
        ...
        {historyLoading ? (
                ...
                <div key={index} className={styles.historyItem}>
                  <div className={styles.workoutInfo}>
                    ...
                    <Typography size={12} className={styles.workoutDetails}>
                      {workout.actualDistance}km • {workout.actualTime}min
                    </Typography>
                  </div>
                  <div className={styles.workoutScore}>
                    <Typography
                      size={12}
                      weight="medium"
          ...
          <div className={styles.emptyHistory}>
            <Typography size={14} className={styles.emptyText}>
              No workouts yet. Start your first run!
            </Typography>
          </div>
        )}
      </div>
